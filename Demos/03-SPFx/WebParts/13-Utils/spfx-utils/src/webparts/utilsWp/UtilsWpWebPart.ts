...
import styles from "./UtilsWpWebPart.module.scss";
import * as strings from "UtilsWpWebPartStrings";

export interface IUtilsWpWebPartProps {
  description: string;
}

export default class UtilsWpWebPart extends BaseClientSideWebPart<IUtilsWpWebPartProps> {
  public render(): void {
