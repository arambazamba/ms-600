# YoutubeUnfurling Bot - `youtubeUnfurlingBot`
...
3. Give the bot a handle (ex: `youtubeUnfurlingBot`), choose your subscription and resource group
4. For the messaging endpoint, use this: `https://linkunfurling.azurewebsites.net/api/messages`
