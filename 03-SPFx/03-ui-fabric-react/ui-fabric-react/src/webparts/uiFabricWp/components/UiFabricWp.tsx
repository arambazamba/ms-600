...
import styles from "./UiFabricWp.module.scss";
import { IUiFabricWpProps } from "./IUiFabricWpProps";
...
export default class UiFabricWp extends React.Component<IUiFabricWpProps, {}> {
  constructor(props) {
    super(props);
