...
var UserAgentApplication = /** @class */ (function () {
    ...
    UserAgentApplication.prototype.getCachedIdToken = function (serverAuthenticationRequest, account) {
        var authority = serverAuthenticationRequest.authority || this.authority;
        var idTokenCacheItem = this.cacheStorage.getIdToken(this.clientId, account ? account.homeAccountIdentifier : null, authority);
    ...
    UserAgentApplication.prototype.getCachedAccessToken = function (serverAuthenticationRequest, account, scopes) {
        ...
        if (!serverAuthenticationRequest.authority || UrlUtils_1.UrlUtils.isCommonAuthority(serverAuthenticationRequest.authority) || UrlUtils_1.UrlUtils.isOrganizationsAuthority(serverAuthenticationRequest.authority)) {
            ...
            for (var i = 0; i < tokenCacheItems.length; i++) {
                 ...
                 *
                 */
                var searchScopes = ScopeSet_1.ScopeSet.removeDefaultScopes(scopes);
                if (searchScopes.length === 0 && ScopeSet_1.ScopeSet.containsScope(cachedScopes, scopes)) {
                    filteredItems.push(cacheItem);
                }
                else if (ScopeSet_1.ScopeSet.containsScope(cachedScopes, searchScopes)) {
                    filteredItems.push(cacheItem);
                }
            }
...
var AuthCache = /** @class */ (function (_super) {
     ...
     */
    AuthCache.prototype.getIdToken = function (clientId, homeAccountIdentifier, authority) {
        var idTokenKey = {
            authority: authority,
            clientId: clientId,
            scopes: undefined,
        ...
        var idTokenKeyString = JSON.stringify(idTokenKey);
        var idToken = this.getItem(idTokenKeyString);
        if (idToken) {
            try {
                var idTokenValue = JSON.parse(idToken);
                /**
                 ...
                 */
                return new AccessTokenCacheItem_1.AccessTokenCacheItem(idTokenKey, idTokenValue);
            }
            catch (e) {
                throw ClientAuthError_1.ClientAuthError.createCacheParseError(idTokenKeyString);
            }
        }
        return null;
    };
