...
import { MessageFactory, StatePropertyAccessor, InputHints, TurnContext, CardFactory } from 'botbuilder';
...
export class MainDialog extends ComponentDialog {
    ...
    constructor() {
        ...
        this.addDialog(new TextPrompt('TextPrompt'))
            ...
            .addDialog(new WaterfallDialog(MAIN_WATERFALL_DIALOG_ID, [this.introStep.bind(this), this.actStep.bind(this), this.finalStep.bind(this)]));
