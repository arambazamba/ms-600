...
export interface IFirstMathTabRemoveState extends ITeamsBaseComponentState {
    value: string;
}
export interface IFirstMathTabRemoveProps {

}

/**
 * Implementation of FirstMathTab remove page
 */
export class FirstMathTabRemove  extends TeamsBaseComponent<IFirstMathTabRemoveProps, IFirstMathTabRemoveState> {
